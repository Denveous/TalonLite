...
$debloatProcess = Start-Process powershell.exe -PassThru -ArgumentList "-executionpolicy bypass -File '$ScriptPath\Win11Debloat\Win11Debloat.ps1' $arguments" -Verb RunAs
